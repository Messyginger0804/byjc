...
export default function HomePage() {
    return (
        <div className="bg-light text-dark dark:bg-dark dark:text-light transition-colors duration-300">
            ...
            <p>why wont this work ld;sfo'pdsjkgopdfsjgoilkdfsnmgviolkdslnfldkshvdsoklij ndsiolfj dsilkfjhidoslk gfndioslhfjdkljsafhjiodsdj ndsiolkf jidloksfgjdiosk jfndsioklkj fndsaklfh dioskns iolwdkjfdkl fdsiolkf dsiofjdwsn klvjdfsngiof ewmfniodscj ndskjlf jewsdf jdwsoifnedsuof h</p>
