         ...
         hover:-translate-y-2 transition-all duration-500 group flex flex-col'>
            ...
            <div className='flex flex-col flex-1'>
                ...
                <div className='flex-1 mb-6'>
                    ...
                    <p className='text-sm opacity-80 leading-relaxed text-balance'>{renderLinkedTechText(proj.desc, maxDescLength)}</p>
                </div>

                {/* Buttons container */}
                <div className='flex justify-evenly mt-auto pt-6 border-t border-dark/5 dark:border-light/5'>
                    <a href={proj.repo} className='px-4 py-2 text-sm font-bold rounded-xl border border-dark/20 dark:border-light/20 hover:bg-dark hover:text-light dark:hover:bg-light dark:hover:text-dark transition-all duration-300 shadow-sm' target='_blank' rel='noopener noreferrer'>
                        GitHub
                    </a>
