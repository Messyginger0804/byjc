        ...
        <footer className="mt-16 mx-4 sm:mx-10 mb-8 rounded-3xl glass flex flex-col items-center text-dark dark:text-light overflow-hidden shadow-modern">
            <div className="w-full bg-accent/10 dark:bg-accentDark/10 py-10 px-6 flex flex-col items-center">
                <nav className="flex flex-wrap justify-center gap-x-8 gap-y-4 font-bold text-sm sm:text-lg uppercase tracking-wider">
                    <Link href='/' className="hover:text-accent dark:hover:text-accentDark transition-colors">Home</Link>
                    <Link href='/about' className="hover:text-accent dark:hover:text-accentDark transition-colors">About</Link>
                    <Link href='/blogs' className="hover:text-accent dark:hover:text-accentDark transition-colors">Blogs</Link>
                    <Link href='/portfolio' className="hover:text-accent dark:hover:text-accentDark transition-colors">Portfolio</Link>
                    <Link href='/contact' className="hover:text-accent dark:hover:text-accentDark transition-colors">Contact</Link>
                </nav>
