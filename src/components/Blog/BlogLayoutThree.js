...
const BlogLayoutThree = ({ blog }) => {
    return (
        <div className="group flex flex-col items-center text-dark dark:text-light transition-all duration-300 hover:-translate-y-2">
            <Link href={blog.url} className="w-full h-64 md:h-80 rounded-2xl overflow-hidden relative shadow-modern group-hover:shadow-modern-lg transition-all duration-500">
                <Image
